...
export default function KlinePanel({ symbol, onSymbolChange }: KlinePanelProps) {
    ...
    useEffect(() => {
        if (period === '1d' || minuteUnavailable) return
